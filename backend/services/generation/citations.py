"""
AIDocumentIndexer - Citation Support
=====================================

Inline citation generation and formatting for document generation.
Supports numbered citations [1], superscript, and author-year styles.
"""
...
if TYPE_CHECKING:
    from backend.services.generation.models import Section, SourceReference
